...
// Generation date: 2014-01-19 06:41
	...
	public partial class ");
        ...
        public ");
            ...
            this.Output.Write("TableAdapter() {\r\n            this.ClearBeforeFill = true;\r\n        }\r\n        \r\n" +
                    "        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]\r\n        [gl" +
                    "obal::System.CodeDom.Compiler.GeneratedCodeAttribute(\"System.Data.Design.TypedDa" +
                    "taSetGenerator\", \"4.0.0.0\")]\r\n        protected internal global::System.Data.Sql" +
                    "Client.SqlDataAdapter Adapter {\r\n            get {\r\n                if ((this._a" +
                    "dapter == null)) {\r\n                    this.InitAdapter();\r\n                }\r\n" +
                    "                return this._adapter;\r\n            }\r\n        }\r\n        \r\n     " +
                    "   [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]\r\n        [global:" +
                    ":System.CodeDom.Compiler.GeneratedCodeAttribute(\"System.Data.Design.TypedDataSet" +
                    "Generator\", \"4.0.0.0\")]\r\n        internal global::System.Data.SqlClient.SqlConne" +
                    "ction Connection {\r\n            get {\r\n                if ((this._connection == " +
                    "null)) {\r\n                    this.InitConnection();\r\n                }\r\n       " +
                    "         return this._connection;\r\n            }\r\n            set {\r\n           " +
                    "     this._connection = value;\r\n                if ((this.Adapter.InsertCommand " +
                    "!= null)) {\r\n                    this.Adapter.InsertCommand.Connection = value;\r" +
                    "\n                }\r\n                if ((this.Adapter.DeleteCommand != null)) {\r" +
                    "\n                    this.Adapter.DeleteCommand.Connection = value;\r\n           " +
                    "     }\r\n                if ((this.Adapter.UpdateCommand != null)) {\r\n           " +
                    "         this.Adapter.UpdateCommand.Connection = value;\r\n                }\r\n    " +
                    "            for (int i = 0; (i < this.CommandCollection.Length); i = (i + 1)) {\r" +
                    ...
                    ".Data.Design.TypedDataSetGenerator\", \"4.0.0.0\")]\r\n        internal global::Syste" +
                    "m.Data.SqlClient.SqlTransaction Transaction {\r\n            get {\r\n              " +
                    "  return this._transaction;\r\n            }\r\n            set {\r\n                t" +
                    "his._transaction = value;\r\n                for (int i = 0; (i < this.CommandColl" +
                    "ection.Length); i = (i + 1)) {\r\n                    this.CommandCollection[i].Tr" +
                    "ansaction = this._transaction;\r\n                }\r\n                if (((this.Ad" +
                    "apter != null) \r\n                            && (this.Adapter.DeleteCommand != n" +
                    "ull))) {\r\n                    this.Adapter.DeleteCommand.Transaction = this._tra" +
                    ...
                    "stem.Data.Design.TypedDataSetGenerator\", \"4.0.0.0\")]\r\n        protected global::" +
                    "System.Data.SqlClient.SqlCommand[] CommandCollection {\r\n            get {\r\n     " +
                    "           if ((this._commandCollection == null)) {\r\n                    this.In" +
                    "itCommandCollection();\r\n                }\r\n                return this._commandC" +
                    "ollection;\r\n            }\r\n        }\r\n        \r\n        [global::System.Diagnost" +
                    "ics.DebuggerNonUserCodeAttribute()]\r\n        [global::System.CodeDom.Compiler.Ge" +
                    "neratedCodeAttribute(\"System.Data.Design.TypedDataSetGenerator\", \"4.0.0.0\")]\r\n  " +
                    "      public bool ClearBeforeFill {\r\n            get {\r\n                return t" +
                    "his._clearBeforeFill;\r\n            }\r\n            set {\r\n                this._c" +
                    "learBeforeFill = value;\r\n            }\r\n        }\r\n        \r\n\t\t[global::System.D" +
                    "iagnostics.DebuggerNonUserCodeAttribute()]\r\n        [global::System.CodeDom.Comp" +
                    "iler.GeneratedCodeAttribute(\"System.Data.Design.TypedDataSetGenerator\", \"4.0.0.0" +
                    "\")]\r\n        private void InitAdapter() {\r\n            this._adapter = new globa" +
                    "l::System.Data.SqlClient.SqlDataAdapter();\r\n            global::System.Data.Comm" +
                    "on.DataTableMapping tableMapping = new global::System.Data.Common.DataTableMappi" +
