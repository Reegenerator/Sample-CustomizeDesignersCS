namespace CustomizeDesigners.Settings
{
    ...
    public partial class SettingsRenderer
    {
        /// <summary>
        ...
        {
            base.PreRender();
            this.settingsFile = SettingsSchemaFactory.Create<SettingsFile>(base.ProjectItem);
        }
        ...
        {
            foreach (SettingsFileSetting setting in this.settingsFile.Settings)
            {
                switch (setting.Type)
                {
